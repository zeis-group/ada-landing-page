...
<body>
  ...
  <main role="main">
    ...
    <section class="jumbotron text-center">
      <div class="jumbotron-bg-video-wrapper">
        <video autoplay muted loop playsinline poster="">
          <!-- <source src="video/istockphoto-1161984646-640_adpp_is.mp4" type="video/mp4"> -->
          <!-- <source src="video/istockphoto-1811601734-640_adpp_is.mp4" type="video/mp4"> -->
          <!-- <source src="video/istockphoto-2153479897-640_adpp_is.mp4" type="video/mp4"> -->
          <source src="video/istockphoto-2155395160-640_adpp_is.mp4" type="video/mp4">
    ...
    <div class="pb-5 bg-light callout">
      <div class="container">
        <div class="row justify-content-center">
          <div class="col-md-6 box p-3 rounded box-shadow">

            <div class="container">
              <div class="row">
                <div class="col-md-3 d-flex align-items-center justify-content-center">
                    <p style="font-size: 4rem; color: #000000;font-weight: bold;">!</p>
                </div>
                <div class="col-md-9 d-flex align-items-center">
                  <p><strong>Stay tuned for plan updates and announcements exclusively for ADA&nbsp;members.</strong><br>Have questions today? Call us at [insert phone number]. Our team is ready to&nbsp;help!</p>
                </div>
              </div>
            </div>
